          ...
          wes_anderson_palette = "Moonrise3") 
{
  ...
  phenos_per_branch_plt <- ggplot(phenos_per_branch, aes(x = n_phenos, 
    ...
    geom_segment(mapping = aes(xend = 0,  yend = branch), size = 3, colour = phenos_per_branch$color) + xlab("Descendants (n)") + 
    ylab(element_blank()) + 
...
print(plot_npc + main_branch_plt + facet_branch_plt + plot_layout(design = layout))
