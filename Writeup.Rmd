...
params:
  ...
  keyword_1: "heart"
  similar_keyword_1: c("heart","atria","aorta")
  keyword_2: "circulating"
  similar_keyword_2: c("circulating","circulate","circulation")
  keyword_3: "glucose"
  similar_keyword_3: c("gluc","glucose")
---
...
```{r, message = FALSE}
HeartTerms <- paste(paste0("(?i)", params$similar_keyword_1), collapse = "|")
CircTerms<- paste(paste0("(?i)", params$similar_keyword_2), collapse = "|")
GlucTerms <- paste(paste0("(?i)", params$similar_keyword_3), collapse = "|")
