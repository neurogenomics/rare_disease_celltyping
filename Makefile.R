...
# File locations
output_ctd_file_name = "data/ctd_tm_l1l2_nzTEST.rda"
ewce_output_all_phenotypes = "results/EWCE_output_all_phenotypes"
merged_results_rda_filename = "results/resultsTest_merged.rda" # <- "all_results_merged_fixednames.rda" (use these results to test the final knit)
...
# Render Writeup
render_writeup(r_markdown_file, writeup_name = "Test2_Writeup",
