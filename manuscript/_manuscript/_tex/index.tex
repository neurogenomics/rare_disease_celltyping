...
phenotypes across 8,628 RDs, greatly increasing the collective knowledge
of RD phenotype-cell type mechanisms. Next, we sought to systematically
...
therapy (e.g.~cell type specificity, postnatal treatability).
Furthermore, we have made these results entirely reproducible and freely
accessible to the global community to maximise their impact, including
an interactive web portal
(\url{https://neurogenomics-ukdri.dsi.ic.ac.uk/}). To summarise, this
work represents a significant step forward in the mission to treat
patients across an extremely diverse spectrum of serious RDs.
...
2025-08-08)\textsuperscript{60}. Overall, we prioritised \(87\)\% (120
...
therapy from the Therapeutic Target Database (TTD; release 2025-08-08)
...
the Sugiyama algorithm\textsuperscript{97}.}
...
\caption{\label{fig-therapy-examples-supp-b}\textbf{Causal multi-scale
...
\caption{\label{fig-therapy-examples-supp-c}\textbf{Causal multi-scale
network for dementia phenotypes.}}
...
\caption{\label{fig-therapy-examples-supp-d}\textbf{Causal multi-scale
...
\caption{\label{fig-therapy-examples-supp-e}\textbf{Causal multi-scale
...
\caption{\label{fig-therapy-examples-supp-f}\textbf{Causal multi-scale
...
\caption{\label{fig-therapy-examples-supp-g}\textbf{Causal multi-scale
...
\caption{\label{tbl-foetal_examples}\textbf{Examples of specific
