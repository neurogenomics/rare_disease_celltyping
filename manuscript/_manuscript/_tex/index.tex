...
the Sugiyama algorithm\textsuperscript{56}. \textbf{b} Expression
...
\includegraphics[width=5.73in,height=\textheight,keepaspectratio]{index_files/figure-pdf/fig-therapy-examples-1.png}
...
connected to cell types (orange circles) via association testing between
...
spatially arranged using the Sugiyama algorithm\textsuperscript{56}.}
...
arranged using the Sugiyama algorithm\textsuperscript{56}.}
