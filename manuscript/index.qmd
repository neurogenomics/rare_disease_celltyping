...
cat("[write_additional_file_2] starting\n")
if (requireNamespace("openxlsx", quietly = TRUE)) {
  ...
  cat("[write_additional_file_2] writing to:", additional_file_2_path, "\n")
  openxlsx::write.xlsx(
  ...
  cat("[write_additional_file_2] wrote", length(additional_file_2_sheets), "sheets to", additional_file_2_path, "\n")
} else {
  cat("[write_additional_file_2] openxlsx not installed; skipping.\n")
}
```
