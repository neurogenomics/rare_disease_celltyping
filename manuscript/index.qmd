...
- **Additional file 1** (`additional_file_1.pdf`): _Supplementary figures._
  PDF containing all supplementary figures (Fig. S1-S18) referenced in the main text, each with its full legend. Figure titles are formatted as "Fig S1", "Fig S2", ... to match the in-text citations of the form "Additional file 1: Fig. S1".

- **Additional file 2** (`additional_file_2.xlsx`): _Supplementary tables._
  Multi-sheet Excel workbook containing all supplementary tables (Table S1, S2, ...) cited in the main text in the form "Additional file 2: Table S1". Each sheet is titled with the matching "Table S*N*:" prefix; large machine-readable result tables (e.g., HPO-to-ontology mappings, enrichment summaries, on-target cell type curation, permutation-test results, hypergeometric tests) are provided in this file so they remain accessible to machine-reading software.
