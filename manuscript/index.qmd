...
Despite its broad definition, 'Neuronal loss in central nervous system' was associated with only `r length(unique(neuronal_loss$cl_name))` cell types: `r paste(unique(neuronal_loss$cl_name), collapse=', ')`, specifically M2 macrophages and sinusoidal endothelial cells [Fig. @fig-therapy-examples]k.
